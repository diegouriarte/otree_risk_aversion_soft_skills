...
class Player(BasePlayer):
    ...
    Q5 = models.IntegerField(label="Abierto a nuevas experiencias", **Constants.field_args)
    Q6 = models.IntegerField(label="Reservado, tranquilo", **Constants.field_args)
    Q7 = models.IntegerField(label="Simpático, amable", **Constants.field_args)
    Q8 = models.IntegerField(label="Desorganizado, descuidado", **Constants.field_args)
    Q9 = models.IntegerField(label="Tranquilo, emocionalmente estable", **Constants.field_args)
